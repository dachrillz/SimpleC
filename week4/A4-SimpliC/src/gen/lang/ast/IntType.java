...
/**
 * @ast node
 * @declaredat /home/chrille/compilers/week4/A4-SimpliC/src/jastadd/lang.ast:39
...
public class IntType extends Type implements Cloneable {
  /**
   * @aspect Visitor
   * @declaredat /home/chrille/compilers/week4/A4-SimpliC/src/jastadd/Visitor.jrag:83
   */
...
protected boolean isIntType_visited = false;
   ...
   * @attribute syn
   * @aspect IntType
   * @declaredat /home/chrille/compilers/week4/A4-SimpliC/src/jastadd/types.jrag:9
   */
...
protected boolean toString_visited = false;
   ...
   * @attribute syn
   * @aspect IntType
   * @declaredat /home/chrille/compilers/week4/A4-SimpliC/src/jastadd/types.jrag:11
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="IntType", declaredAt="/home/chrille/compilers/week4/A4-SimpliC/src/jastadd/types.jrag:11")
...
protected boolean isBooleanType_visited = false;
   ...
   * @attribute syn
   * @aspect BooleanType
   * @declaredat /home/chrille/compilers/week4/A4-SimpliC/src/jastadd/types.jrag:21
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
...
protected boolean isUnknownType_visited = false;
   ...
   * @attribute syn
   * @aspect UnknownType
   * @declaredat /home/chrille/compilers/week4/A4-SimpliC/src/jastadd/types.jrag:33
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
