...
/**
 * @ast node
 * @declaredat /home/chrille/compilers/week4/A4-CalcRAG/src/jastadd/calc.ast:11
...
public class Let extends Expr implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /home/chrille/compilers/week4/A4-CalcRAG/src/jastadd/PrettyPrint.jrag:39
   */
...
protected java.util.Set localLookup_String_int_visited;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/chrille/compilers/week4/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:12
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week4/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:12")
  ...
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week4/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:10")
...
protected java.util.Set lookup_String_visited;
  ...
  public IdDecl Define_lookup(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getBindingListNoTransform()) {
      ...
      // @declaredat /home/chrille/compilers/week4/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:5
      {
