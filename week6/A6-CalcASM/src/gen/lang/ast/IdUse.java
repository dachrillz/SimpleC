...
/**
 * @ast node
 * @declaredat /home/chrille/compilers/week6/A6-CalcASM/src/jastadd/calc.ast:11
...
public class IdUse extends Expr implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /home/chrille/compilers/week6/A6-CalcASM/src/jastadd/PrettyPrint.jrag:31
   */
  ...
  /**
   * @aspect CodeGen
   * @declaredat /home/chrille/compilers/week6/A6-CalcASM/src/jastadd/CodeGen.jrag:152
   */
...
protected boolean decl_visited = false;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-CalcASM/src/jastadd/NameAnalysis.jrag:2
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week6/A6-CalcASM/src/jastadd/NameAnalysis.jrag:2")
  public IdDecl decl() {
...
protected boolean isCircular_visited = false;
   ...
   * @declaredat /home/chrille/compilers/week6/A6-CalcASM/src/jastadd/NameAnalysis.jrag:32
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="CircularDefinitions", declaredAt="/home/chrille/compilers/week6/A6-CalcASM/src/jastadd/NameAnalysis.jrag:32")
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-CalcASM/src/jastadd/NameAnalysis.jrag:3
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week6/A6-CalcASM/src/jastadd/NameAnalysis.jrag:3")
...
protected java.util.Set lookup_String_visited;
   ...
   * @attribute inh
   * @aspect CircularDefinitions
   * @declaredat /home/chrille/compilers/week6/A6-CalcASM/src/jastadd/NameAnalysis.jrag:33
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="CircularDefinitions", declaredAt="/home/chrille/compilers/week6/A6-CalcASM/src/jastadd/NameAnalysis.jrag:33")
...
protected java.util.Set inExprOf_IdDecl_visited;
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/chrille/compilers/week6/A6-CalcASM/src/jastadd/Errors.jrag:34
    if (decl().isUnknown()) {
      {
    ...
    // @declaredat /home/chrille/compilers/week6/A6-CalcASM/src/jastadd/Errors.jrag:42
    if (isCircular()) {
      {
        Program target = (Program) (program());
        java.util.Set<ASTNode> contributors = _map.get(target);
