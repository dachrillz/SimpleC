...
public class LangParser extends Parser {
	static public class Terminals {
		...
		static public final short LET = 6;
	...
	static final ParsingTables PARSING_TABLES = new ParsingTables(
		"U9oraiio0r4GXlyp4IGPCHCHGMoiyW1MLbPMMLbJoWCeNe344r0Mb8MD1tH9nltI$XvpQKH" +
		"PAEUlhywPqt$tdEav02xGG16Z6CCuFBJGX2#NychqRFHaz6ZqO7IVozIkoelHhT6DqPNHdT" +
		"5RBbDp3dKKC8bfpXM4A64gcqSoLrtwqezzQQoSnp2F2V8zFp2U6JHb88Cq9WAWfXKbaWYpS" +
		"WsVLQfyGq17ZTbrdWbmx6WXFibVrhRsVzHqoPvBlhUKpRdBPRa$nTml#TeLzQKni8kLkABk" +
		"bYbWeOTuR90piaLqFo0DqYABP8UqYThtoHvP9mTaYHoHPR92Lac7h95ZSa8EoIuv9UTQH4I" +
		"YvDsRlQImXMCxzN7gwZcI$Uum$v3ypfTd7I5lYOl$GCXEA3xNd$7OmoAxwF5EEU9zt3okjP" +
		"$QsSOxgF3APG==");
	...
	protected Symbol invokeReduceAction(int rule_num, int offset) {
		switch(rule_num) {
			...
			case 8: // factor = MINUS factor.f
			{
					final Symbol _symbol_f = _symbols[offset + 2];
					final Expr f = (Expr) _symbol_f.value;
					 return new Neg(f);
			}
			case 9: // let = LET binding_list.a IN exp.b END
			{
