...
/**
 * @ast node
 * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/lang.ast:32
...
public class IdDecl extends Expr implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/PrettyPrint.jrag:51
   */
  ...
  /**
   * @aspect CodeGen
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:199
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/Visitor.jrag:190
   */
  ...
  /**
   * @aspect Interpreter
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/interpreter.jrag:190
   */
...
protected boolean uniqueID_visited = false;
   ...
   * @attribute syn
   * @aspect UniqueNames
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/UniqueNames.jrag:11
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="UniqueNames", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/UniqueNames.jrag:11")
...
protected boolean type_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:14
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:14")
  public Type type() {
    ASTState state = state();
    if (type_computed) {
      return type_value;
...
protected boolean isVariableAndFunction_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:187
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:187")
...
protected java.util.Set equalsParameters_FuncCall_visited;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:195
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:195")
...
protected boolean isUnknown_visited = false;
   ...
   * @attribute syn
   * @aspect UnknownDecl
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/UnknownDecl.jrag:7
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="UnknownDecl", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/UnknownDecl.jrag:7")
...
protected boolean localIndex_visited = false;
   ...
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:363
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
...
protected boolean isMultiDeclared_visited = false;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:102
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:102")
  ...
  @ASTNodeAnnotation.Source(aspect="UniqueNames", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/UniqueNames.jrag:10")
...
protected java.util.Set uniqueName_String_visited;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:174")
...
protected boolean isVariable_visited = false;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:175")
...
protected boolean isFunction_visited = false;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:190")
...
protected boolean function_visited = false;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="AddressHandling", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:349")
...
protected boolean address_visited = false;
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:49
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:49")
...
protected java.util.Set lookup_String_visited;
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/Errors.jrag:75
