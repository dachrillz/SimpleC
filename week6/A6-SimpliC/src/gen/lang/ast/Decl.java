...
/**
 * @ast node
 * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/lang.ast:8
...
public class Decl extends Statement implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/PrettyPrint.jrag:241
   */
  ...
  /**
   * @aspect CodeGen
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:130
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/Visitor.jrag:100
   */
  ...
  /**
   * @aspect Interpreter
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/interpreter.jrag:54
   */
...
protected boolean compatibleTypes_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:145
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:145")
...
protected java.util.Set lookup_String_visited;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:44
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:44")
...
protected java.util.Set isMulti_String_visited;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:98
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:98")
  ...
  public Type Define_expectedType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getExprOptNoTransform()) {
      // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:167
      return intType();
    }
    else {
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/Errors.jrag:38
    ...
    // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/Errors.jrag:47
    if (!compatibleTypes()) {
      {
        Program target = (Program) (program());
        java.util.Set<ASTNode> contributors = _map.get(target);
