...
/**
 * @ast node
 * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/lang.ast:2
...
public class Function extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/PrettyPrint.jrag:15
   */
  ...
  /**
   * @aspect CodeGen
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:44
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/Visitor.jrag:91
   */
  ...
  /**
   * @aspect Interpreter
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/interpreter.jrag:15
   */
...
protected ASTState.Cycle reachable_cycle = null;
  ...
  @ASTNodeAnnotation.Source(aspect="Reachability", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/Reachability.jrag:3")
...
protected boolean controlIndex_visited = false;
   ...
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:348
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="AddressHandling", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:348")
  public int controlIndex() {
    ...
    if (controlIndex_visited) {
      throw new RuntimeException("Circular definition of attribute Function.controlIndex().");
    }
    controlIndex_visited = true;
    state().enterLazyAttribute();
    controlIndex_value = 0;
...
protected boolean localIndex_visited = false;
   ...
   * @attribute syn
   * @aspect AddressHandling
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:374
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="AddressHandling", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:374")
  public int localIndex() {
    ...
    if (localIndex_visited) {
      throw new RuntimeException("Circular definition of attribute Function.localIndex().");
    }
...
protected java.util.Set localLookup_String_visited;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:14
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:14")
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:7
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:7")
...
protected java.util.Set lookup_String_visited;
  ...
  /**
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/UniqueNames.jrag:10
   * @apilevel internal
   */
  public String Define_uniqueName(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getBlockNoTransform()) {
      // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/UniqueNames.jrag:4
      return name;
    }
    else if (_callerNode == getArgumentsListNoTransform()) {
      // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/UniqueNames.jrag:3
  ...
  public boolean Define_isFunction(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getNameNoTransform()) {
      // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:182
      return true;
    }
    else {
  ...
  /**
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/TypeAnalysis.jrag:190
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:349
   * @apilevel internal
   */
  public String Define_address(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getArgumentsListNoTransform()) {
      // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CodeGen.jrag:351
  ...
  public IdDecl Define_lookup(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getBlockNoTransform()) {
      // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:9
      {
  ...
  public boolean Define_isMulti(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getBlockNoTransform()) {
      // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/NameAnalysis.jrag:74
      {
...
protected boolean Function_functionCalls_visited = false;
  ...
  @ASTNodeAnnotation.Source(aspect="CallGraph", declaredAt="/home/chrille/compilers/week6/A6-SimpliC/src/jastadd/CallGraph.jrag:28")
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/chrille/compilers/week6/A6-SimpliC/src/jastadd/Errors.jrag:42
